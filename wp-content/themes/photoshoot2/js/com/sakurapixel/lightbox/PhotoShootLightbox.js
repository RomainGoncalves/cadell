...
function PhotoShootLightbox(items, startIndex){
    ...
    function init(){
        ...
        $('#photoShootLightbox').css("background-image", "url('"+globalJS.RESOURCES_PATH+"/photoshootlightbox/blackBackground.png')");
        ...
        //left button
        $('<div id="leftBTN"><img src="'+globalJS.RESOURCES_PATH+'/'+'photoshootlightbox/left_btn.png" alt="left" /></div>').appendTo($('#lightboxContent'));
        ...
        //right button
        $('<div id="rightBTN"><img src="'+globalJS.RESOURCES_PATH+'/'+'photoshootlightbox/right_btn.png" alt="right" /></div>').appendTo($('#lightboxContent'));
        ...
        $('<div id="lightboxClose"><img src="'+globalJS.RESOURCES_PATH+'/'+'photoshootlightbox/close_lightbox.png" alt="" /></div>').appendTo($('#lightboxContent'));
        ...
        //preloader
        $('<div id="lightBoxPreloader"><img src="'+globalJS.RESOURCES_PATH+'/'+'photoshootlightbox/preloader.gif" /></div>').appendTo($('#photoShootLightbox'));
        ...
        if(!lightBoxImageMouseMove){
           if(imageUI!=undefined){
               ...
               if(imgWidth>lightboxContent.width()){
                   ...
                   imageUI.css('left', $('#imageContent').width()/2-newW/2);
                   imageUI.css('top', $('#imageContent').height()/2-newH/2);
    ...
    function widowResized(){
        ...
        $('#imageContent').css('height', $('#lightboxContent').height()-20+'px');
            ...
            $('#imageContent img').css('width', originalImageW+'px');
            $('#imageContent img').css('height', originalImageH+'px');      
