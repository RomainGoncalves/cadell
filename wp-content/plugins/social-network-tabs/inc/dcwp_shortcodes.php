...
function dc_social_tabs_shortcode( $atts, $content = null ){
	...
	$out .= 'if(!jQuery().dcSocialTabs) { $.getScript("'.dc_jqsocialtabs::get_plugin_directory().'/js/jquery.social.media.tabs.1.7.min.js", function(){$("#social-tabs").dcSocialTabs(config);}); } else {';
